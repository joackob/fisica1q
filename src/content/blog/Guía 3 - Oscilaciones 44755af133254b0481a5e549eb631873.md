...
<aside>
💡 Para encontrar solución a una **ecuación diferencial lineal homogénea de segundo orden con coeficientes constantes** se utiliza las raíces de la ecuación característica asociada, ver [apéndice](https://www.notion.so/Ap-ndice-Ecuaciones-diferenciales-lineales-homog-neas-de-segundo-orden-con-coeficientes-constantes-023d2d12b0b14ea69d931397a0e2b52e?pvs=21).
